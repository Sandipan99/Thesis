...
\TitleBottom{{\bigsize \bf Structure, Function and Application}}
...
%Date:\hspace{1cm}  \\  \\
Certified that the thesis entitled {\bf ``Temporal Networks: Structure, Function and Application''} 
...
Prof. Debdeep Mukhopadhyay \hfill Prof. Anumpam Basu \hfill Prof. Anirban Mukherjee\\
...
\noindent
%\hspace{2cm}
Prof. Sudeshna Sarkar\hfill Prof. Animesh Mukherjee\hfill Prof. Niloy Ganguly\\
(HoD CSE)~~~~~~~~~~~~~~\hspace{2cm}(Supervisor)\hspace{2.5cm} (Co-Supervisor)\hfill ~~~~~~~
...
%\hspace{2cm}
\noindent
Prof. Amitabha Bagchi \hspace{3cm} Prof. Jayanta Mukhopadhyay\\ 
...
\Certificate{
\noindent%
{\em This is to certify that the thesis entitled {\bf ``Temporal Networks: Structure, Function and Application''}, submitted by {\bf
...
\input{texfiles/Introduction/intro_all.tex}
% \clearpage
...
\input{texfiles/Chapter_4/introduction_all}
%\input{texfiles/Chapter_4/jcdl/introduction}
%\input{texfiles/Chapter_4/cikm/introduction}
...
\input{texfiles/Chapter_4/jcdl/dataset}
...
\input{texfiles/Chapter_4/summary}
%\input{texfiles/Chapter_4/cikm/conclusion}
%\input{texfiles/Chapter_4/cikm_17/conclusion}
%\clearemptydoublepage
\clearpage
\clearpage
