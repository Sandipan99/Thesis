...
\input{./texfiles/Chapter_1/temp_introduction}

%\input{temp_related_works}

\input{./texfiles/Chapter_1/temp_mapping_network_time_series}

\input{./texfiles/Chapter_1/temp_dataset_description}

\input{./texfiles/Chapter_1/temp_properties_time_series}
 
\input{./texfiles/Chapter_1/temp_spectrogram}

\input{./texfiles/Chapter_1/temp_prediction}
 

\input{./texfiles/Chapter_1/temp_result_discussion}

\input{./texfiles/Chapter_1/temp_insights}

\input{./texfiles/Chapter_1/temp_conclusion}
